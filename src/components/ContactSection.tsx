        ...
        <div className="grid lg:grid-cols-2 gap-8 mt-6 items-start">
          <div className="card bg-base-100 shadow-xl border border-base-300">
            <div className="card-body">
              ...
              <p className="text-lg">
                Phone: <a href="tel:02392 696751" className="link link-secondary">02392 696751</a>
              </p>
              <p className="text-lg">
                Email: <a href="mailto:info@bradleysbathrooms.com" className="link link-secondary">info@bradleysbathrooms.com</a>
              </p>
              <p className="opacity-80">
                Opening hours: Tues-Sat 09:00–16:00
              </p>
          ...
          <div className="card bg-base-100 shadow-xl border border-base-300 overflow-hidden">
            ...
            <div className="px-6 pb-6">
              ...
              >
                <iframe
                  title="Bradleys Bathrooms — map"
                  className="absolute inset-0 w-full h-full"
                  frameBorder={0}
                  scrolling="no"
                  marginHeight={0}
                  marginWidth={0}
                  src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=bradleys bathrooms portsmouth&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                />
              </div>
              <a
